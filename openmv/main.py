...
THRESHOLD = (50, 150) # Grayscale threshold for dark things...
...
while(True):
    ...
    # better...
    line = img.get_regression([(0, 0) if BINARY_VISIBLE else THRESHOLD], robust = True)

    if (line): img.draw_line(line.line(), color = 127)

    # if (line): print("" + str(line.theta()))
